...
function setNextButton() {
  ...
  console.log('setNextButton client');
  socket.emit(`setNextButton`, {'letter': currentButtonLetterToPress, 'ledPin': buttons[currentButtonLetterToPress]});
}
